            ...
            <g class="nodes">
              ...
              >
                ...
                <circle
                  ...
                  :stroke="node.id === selectedNode?.id ? '#8b5cf6' : '#ffffff'"
                  :stroke-width="node.id === selectedNode?.id ? 3 : 2"
                  class="drop-shadow-sm"
                />
                
                <!-- Node Icon -->
                <text
                  :font-size="getNodeSize(node.importance) * 0.6"
                  text-anchor="middle"
                  dy="0.35em"
                ...
                <!-- Node Label -->
                <text
                  :y="getNodeSize(node.importance) + 15"
                  text-anchor="middle"
                  class="text-xs fill-gray-700 dark:fill-gray-300 font-medium pointer-events-none"
                >
                  {{ node.label }}
                </text>
              </g>
